...
//   return (
//     <section className="bg-red-700 flex flex-col items-center py-6">
//       {cars.map((car) => (
//         <div
//           key={car.id}
//           className="bg-white rounded-2xl p-3 w-72 mb-6 shadow-md"
//         >
//           <img
//             src={car.img}
//             alt={car.name}
...
export default function CarList() {
  ...
  const handleReserve = (car) => {
    // ✅ Send the car info via navigate state
            ...
            <div className="p-6 text-center">
              ...
              <div className="flex justify-center gap-3 mt-4">
                <motion.button
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  onClick={() => handleReserve(car)} // ✅ Send the car data
                  className="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-red-700 transition-colors shadow-md"
                >
                  Reserve Now
                </motion.button>
